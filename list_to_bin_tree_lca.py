#Input will be given as an array of 3 items
# first string is bintree in string format, 2nd and 3rd are numbers to find lowest common ancestor
#eg : Input = ["[1,2,3,4,#,5,#,#]","2","5"] 
# The # in input binary tree indicates no child.
def solution(input):
